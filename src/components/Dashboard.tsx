...
// COMMENTED OUT: Multi-chain wallet hooks
// import { useAccount, useBalance } from 'wagmi'
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart, Bar, PieChart, Pie, Cell } from 'recharts'
import { TrendingUp, TrendingDown, Activity, DollarSign, Users, ArrowUpRight } from 'lucide-react'

const Dashboard = () => {
  // COMMENTED OUT: Multi-chain wallet connection
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-3xl font-bold text-white">Corporate Treasury Dashboard</h2>
          <p className="text-gray-400 mt-1">PeakeCorp Hive blockchain asset management and analytics</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass rounded-xl p-6">
          <h3 className="text-xl font-semibold text-white mb-4">Treasury Performance</h3>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={portfolioData}>
                ...
                />
                <Line type="monotone" dataKey="hive" stroke="#E31337" strokeWidth={2} name="HIVE" />
                <Line type="monotone" dataKey="hbd" stroke="#00AA55" strokeWidth={2} name="HBD" />
                <Line type="monotone" dataKey="peake" stroke="#FF6B35" strokeWidth={2} name="PEAKE" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <div className="glass rounded-xl p-6">
        <h3 className="text-xl font-semibold text-white mb-4">Recent Corporate Activity</h3>
        <div className="space-y-4">
          {[
            { type: 'Payroll Distribution', chain: 'Hive', amount: '+$8,450', time: '5 minutes ago', status: 'success' },
            { type: 'Vendor Payment', chain: 'Hive → HBD', amount: '-$2,150', time: '20 minutes ago', status: 'success' },
            { type: 'Staking Rewards', chain: 'PeakeCoin', amount: '+$385', time: '1 hour ago', status: 'success' },
            { type: 'Treasury Rebalancing', chain: 'Hive', amount: '+$1,820', time: '3 hours ago', status: 'success' },
            { type: 'Compliance Report', chain: 'Hive', amount: 'Generated', time: '6 hours ago', status: 'success' },
          ].map((activity, index) => (
