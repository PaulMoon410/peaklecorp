...
// COMMENTED OUT: Multi-chain wallet connections
// import { ConnectButton } from '@rainbow-me/rainbowkit'
// import { useAccount, useBalance } from 'wagmi'
import Dashboard from '@/components/Dashboard'
import WorkflowTracker from '@/components/WorkflowTracker'
import Analytics from '@/components/Analytics'
// COMMENTED OUT: Non-Hive blockchain integrations
...
export default function Home() {
  ...
  // COMMENTED OUT: Multi-chain wallet connection state
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex space-x-2">
              {['dashboard', 'workflows', 'analytics', 'batch', 'timeline', 'projects'].map((tab) => (
                <button
                  key={tab}
      ...
      <div className="max-w-7xl mx-auto p-6">
        {!isHiveConnected ? (
          <div className="text-center py-20">
            <div className="glass rounded-2xl p-12 max-w-md mx-auto">
              ...
              <p className="text-gray-300 mb-8">
                Connect your Hive wallet to start using PeakeCorp's enterprise workflow management system
              </p>
              <button
          ...
          <div className="animate-fade-in">
            ...
            {/* COMMENTED OUT: Polkadot integration - will be re-enabled after PeakeCorp is complete */}
